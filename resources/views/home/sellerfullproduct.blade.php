                    ...
                    <div class="box shadow">
                        <div class="option_container">
                            <div class="options">
                                ...
                                <!-- <a href="{{url('product_detailseller',$products->id)}}" class="option1">
                                    Product Detail
                                </a> -->
                               <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <form action="{{url('sendsms',$products->id)}}" method="post">
                                                ...
                                                <div class="row no-gutters">
                                                    <div class="col-md-8 pr-1">
                                                        <input type="text" name="message" class="form-control" style="width:100%" placeholder="Message Seller">
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <form action="{{url('send_seller_email',$products->id)}}" method="post">
                                                ...
                                                <div class="row no-gutters">
                                                    <div class="col-md-8 pr-1">
                                                        <input type="text" name="body" class="form-control" style="width:100%" placeholder="Email Seller">
                                                    </div>
                                                    <div class="col-md-4 pl-1">
                                                        <button class="btn btn-outline-success rounded text-dark" type="submit">Send</button>
                                                    </div>
                                                </div>
                                         </form>
                                            </div>
