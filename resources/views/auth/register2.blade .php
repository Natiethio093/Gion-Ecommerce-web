        ...
        <x-authentication-card>
            ...
            <form method="POST" action="{{url('regnew')}}"> <!-- enctype="multipart/form-data"-->
               ...
               <div>
                ...
                <div class="mt-4">
                    <x-label for="google_id" />
                    <x-input id="goolge_id" class="block mt-1 w-full" type="hidden" name="google_id" :value="old('google_id',$google_id)" required autocomplete="username" />
                </div>
                <div class="mt-4">
